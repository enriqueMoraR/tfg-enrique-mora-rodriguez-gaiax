...
class DatasetServiceUnitTest {
        ...
        @BeforeEach
        void setUp() {
                this.datasetService = new DatasetService(new FhirValidationService(), null, null, null, null, null,
                                null);
        }
        ...
        void shouldRejectDuplicateDatasetId() {
                CreateDatasetRequest request = createRequest("ds-bp-dup", "blood-pressure", "FHIR_BUNDLE",
                ...
                ProviderApiException exception = catchThrowableOfType(ProviderApiException.class,
                                () -> datasetService.createDataset(createRequest("ds-bp-dup", "blood-pressure",
                                                "FHIR_BUNDLE", FhirTestDataLoader.bundleSample())));
        ...
        void shouldListDatasetsWithFiltersAndPagination() {
                datasetService.createDataset(createRequest("ds-bp-1", "blood-pressure", "FHIR_BUNDLE",
                                FhirTestDataLoader.bundleSample()));
                datasetService.createDataset(createRequest("ds-bp-2", "blood-pressure", "FHIR_BUNDLE",
                                FhirTestDataLoader.collectionSample()));
                datasetService.createDataset(createRequest("ds-hr-1", "heart-rate", "FHIR_BUNDLE", heartRateBundle()));
                datasetService.createDataset(createRequest("ds-obs-1", "blood-pressure", "FHIR_OBSERVATION",
                ...
                assertThat(bloodPressure.items())
                                .allSatisfy(item -> assertThat(item.clinicalCase()).isEqualTo("blood-pressure"));
        ...
        private CreateDatasetRequest createRequest(String datasetId, String clinicalCase, String datasetType,
                        JsonNode payload) {
